...
from game_arena.harness import (model_generation, parsers, prompt_generation,
                                prompts, rethink_fn, samplers, tournament_util)
    ...
    def _sample_action(
        ...
        **prompt_substitutions,
            ...
            match self._strategy:
                case tournament_util.SamplerChoice.RETHINK:
                    if self._rethink_template is None:
                        ...
                        raise ValueError(
                            "Rethink template should be initialized as None."
                        )
        ...
        return samplers.SamplerOutput(
            ...
            action=(
                maybe_legal_action if maybe_legal_action is not None else parsed_action
            ),
