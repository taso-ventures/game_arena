...
from game_arena.harness import (model_generation, model_generation_http,
                                model_generation_sdk, tournament_util)
...
flags.DEFINE_integer("num_calls", 1, "Number of times to call the specified model.")
flags.DEFINE_list(
    "use_modality",
    ["text", "image"],
...
It is now your turn. Play your strongest move. The move MUST be legal. Reason step by step to come up with your move, then output your final answer in the format "Final Answer: X" where X is your chosen move in standard algebraic notation (SAN).""",
    ...
    models = {
        ...
        "anthropic_sync": model_generation_sdk.AnthropicModel(
            ...
            model_options={"thinking": {"type": "enabled", "budget_tokens": 8192}},
        ),
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        while pending_futures:
            done, pending_futures = concurrent.futures.wait(pending_futures, timeout=1)
